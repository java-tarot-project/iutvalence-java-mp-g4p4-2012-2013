...
public class Jouer {
	...
	/**
	 * Joueur joueurReel représente la classe utilisée par le Joueur. Par le
	 * biais de cette classe, l'utilisateur va être capable de jouer une partie
	 * de Tarot.
	 */
	public Joueur joueurReel;

	/**
	 * Joueur joueur simulée avec Intelligence Artificielle. Joueur fictif
	 * simulant un des 4 joueurs d'une partie. Non accessible par l'utilisateur.
	 */
	...
	/**
	 * JeudeCarte simulant les différentes cartes auxquelles les joueurs
	 * pourront accéder.
	 */
	...
	/**
	 * Création d'une table de joueurs. Représentation sous forme d'un tableau
	 * de 4 joueurs. ( les quatre joueurs sont censés être autour d'une table)
	...
	/**
	 * Constructeur initialisant les joueurs et le jeu de cartes Création de
	 * quatre Joueurs, création d'un JeudeCarte
	 */
	public Jouer() {
	...
	/**
	 * Méthode initialisant une partie de Tarot Africain. Le principe est de
	 * distribuer {5,4,3,2,1} carte(s) aux quatre joueurs. Suite à quoi les
	 * joueurs misent le nombre de plis susceptibles d'être remportés. Après la
	 * dernière phase d'un tour (distribution d'une seule carte), le premier
	 * joueur devient son voisin de gauche.
	 */
	public void jouer() {
